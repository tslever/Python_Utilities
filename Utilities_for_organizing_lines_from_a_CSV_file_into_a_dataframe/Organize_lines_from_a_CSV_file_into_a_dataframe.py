...
##############################################################################################################################################################
# main represents the primary function of the "Organize lines from a CSV file into a dataframe" program, which organizes lines in a CSV file into a dataframe.
# Usage: python CSV-File_Organizer.py <the path to the CSV file> <the index of the first line to read> <the index of the last line to read>
#
# Author: Tom Lever
# Version: 1.0
# Since: 06/24/21
